    ...
    return(
        <div className="mb-20">
            ...
            <p className="mx-auto leading-relaxed text-base mb-4">
               Cela faisait longtemps que plusieurs historiens l’espéraient alors que d’autres groupements d’intérêts
                diffusaient depuis des décennies des informations au sein des Chambres fédérales
            </p>

            <p className="mx-auto leading-relaxed text-base mb-4">
              A 19 ans, LinkedIn est le grand-père des réseaux sociaux.
              Créé en 2002, soit deux ans avant Facebook (4 ans avant Twitter, 8 ans avant Instagram et 14 ans avant TikTok)
            </p>
